...
<div style="margin-bottom: 25px;">
    ...
    <div class="measurement-grid">
        <div class="measurement-input-wrapper">
            <label for="m_up_length" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_shoulder" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_chest" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_armhole" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_sleeve" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_neck" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_hem_width" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
...
<div style="margin-bottom: 25px;">
    ...
    <div class="measurement-grid">
        <div class="measurement-input-wrapper">
            <label for="m_lo_length" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
                <span>Length (Lambai)</span>
                <span style="color: var(--text-muted); font-size: 10px; font-family: var(--font-urdu);">لمبائی</span>
            </label>
        ...
        <div class="measurement-input-wrapper">
            <label for="m_lo_waist" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_lo_hips" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
                <span>Hips (Hips)</span>
        ...
        <div class="measurement-input-wrapper">
            <label for="m_lo_rise" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
                <span>Rise (Asan)</span>
        ...
        <div class="measurement-input-wrapper">
            <label for="m_lo_bottom_opening" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_lo_inseam" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
                <span>Inseam</span>
...
<div style="margin-bottom: 10px;">
    ...
    <div class="measurement-grid">
        <div class="measurement-input-wrapper">
            <label for="m_up_darts" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
                <span>Darts</span>
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_cut" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_flare" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_upper_chest" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
        ...
        <div class="measurement-input-wrapper">
            <label for="m_up_lower_chest" style="min-height: 34px; display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 2px;">
